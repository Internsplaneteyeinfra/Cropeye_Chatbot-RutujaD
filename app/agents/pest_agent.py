...
# #without default values with API calling functionality
...
# async def _fetch_plantation_date(api: Any, plot_id: str) -> str | None:
#     """Fetch plantation_date from farmer profile (same source as frontend)."""
#     try:
#         profile = await api.get_farmer_profile()
...
#         try:
#             temp = float(data.get("temperature_c", data.get("temperature")))
#         except (TypeError, ValueError):
#             temp = None
...
#         return {
#             "fungi_affected_pixel_percentage": float(ps.get("fungi_affected_pixel_percentage"))
#             if ps.get("fungi_affected_pixel_percentage") is not None else None,

#             "chewing_affected_pixel_percentage": float(ps.get("chewing_affected_pixel_percentage"))
#             if ps.get("chewing_affected_pixel_percentage") is not None else None,

#             "sucking_affected_pixel_percentage": float(ps.get("sucking_affected_pixel_percentage"))
#             if ps.get("sucking_affected_pixel_percentage") is not None else None,

#             "SoilBorn_affected_pixel_percentage": float(ps.get("SoilBorn_affected_pixel_percentage"))
...
# async def pest_agent(state: dict) -> dict:
#     """
#     Runs same risk calculation as frontend pestt (Pests, Diseases, Weeds).
#     Fetches plantation_date, weather, and pest_detection from same backend APIs as frontend
#     when not provided in context.
#     """
